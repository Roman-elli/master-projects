...
from src.config import MERGED_DATA_PATH, colunas_para_converter
...
def carregar_e_limpar_dados():
    ...
    # Volta 2 pastas atrás e junta com 'data/merged_data.csv' do config
    caminho_dados = os.path.join(BASE_DIR, '../../', MERGED_DATA_PATH)

    try:
        df_final = pd.read_csv(caminho_dados, low_memory=False)
...
def calcular_kpis(df):
    ...
    return total_alunos, divida, salario